...
exports.showTranslation = exports.showLanguages = exports.languages = void 0;
...
languages.set('chinese', 'zh'); //zh-cn or zh (bcp-47) //chinese (traditional)	zh-tw (bcp-47)
...
exports.showLanguages = showLanguages;
function showTranslation(body) {
    console.log(body);
}
